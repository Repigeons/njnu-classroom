 ...
 * Generation date: 2022-02-09T16:02:51.37+08:00
 */
...
interface ProMapper {
    ...
    fun insert(insertStatement: InsertStatementProvider<ProRecord>): Int

    @SelectProvider(type = SqlProviderAdapter::class, method = "select")
    @ResultMap("ProRecordResult")
    fun selectOne(selectStatement: SelectStatementProvider): ProRecord?

    @SelectProvider(type = SqlProviderAdapter::class, method = "select")
    @Results(
        id = "ProRecordResult", value = [
    ...
    fun selectMany(selectStatement: SelectStatementProvider): List<ProRecord>

    @UpdateProvider(type = SqlProviderAdapter::class, method = "update")
    fun update(updateStatement: UpdateStatementProvider): Int

    @Update("TRUNCATE TABLE `pro`")
    fun truncate()
