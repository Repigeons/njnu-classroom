 ...
 * Generation date: 2022-11-24T19:04:19.942+08:00
 */
...
interface JasMapper {
    ...
    @SelectKey(statement=["SELECT LAST_INSERT_ID()"], keyProperty="record.jasdm", before=false, resultType=String::class)
    ...
    @SelectProvider(type=SqlProviderAdapter::class, method="select")
    @Results(id="JasRecordResult", value = [
